 ...
 */
export declare type CustomIconLoader = (name: string) => Awaitable<string | undefined>;
/**
 * Custom icon customizer, it will allow to customize all icons on a collection or individual icons.
 */
export declare type IconCustomizer = (collection: string, icon: string, props: Record<string, string>) => Awaitable<void>;
/**
 ...
 */
export declare type IconCustomizations = {
    /**
     * Transform raw `svg`.
     *
 ...
 */
export declare type InlineCollection = Record<string, string | (() => Awaitable<string | undefined>)>;
/**
 * Collection of custom icons. Key is collection name, value is loader or InlineCollection object
 */
export declare type CustomCollections = Record<string, CustomIconLoader | InlineCollection>;
