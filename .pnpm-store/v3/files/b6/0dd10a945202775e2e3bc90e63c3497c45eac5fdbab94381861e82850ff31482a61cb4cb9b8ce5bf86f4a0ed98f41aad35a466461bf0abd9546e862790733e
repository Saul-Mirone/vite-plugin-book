...
export declare const strikeThrough: import("@milkdown/utils/lib/src/types").WithExtend<"StrikeThrough", import("@milkdown/utils").UnknownRecord, import("prosemirror-model").MarkType<any>, {
    id: string;
