...
const Button: FC<{ text: string; onClick: () => void }> = ({ text, onClick }) => {
    return (
        <div
            className="flex justify-center items-center cursor-pointer transition p-3 rounded-xl text-nord0 fill-nord0 hover:bg-gray-100 hover:text-nord10 hover:fill-nord10"
            onClick={onClick}
        >
